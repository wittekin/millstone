...
def test_analyze_task_complexity():
    # Mock dependencies
    with patch("millstone.runtime.orchestrator.load_config") as mock_load_config, \
        ...
        orch.log.assert_called_with("task_complexity_analysis", complexity="simple", reasoning="Simple change")
